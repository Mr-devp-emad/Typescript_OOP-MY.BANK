...
let customers:Customer[] =[
    new Customer ("Ahmed","Ali","Male",28,3001234567,accounts[0]),
    new Customer ("Talha","Khan","Male",24,3331244597,accounts[1]),
    new Customer ("Jawad","Malik","Male",28,3132034527,accounts[2])
]
